...
<Stability level="success" title="2">Stable. Compatibility with the npm ecosystem is a high priority.</Stability>
...
<Stability level="warning" title="1">Experimental. The feature is not subject to semantic versioning rules.</Stability>
